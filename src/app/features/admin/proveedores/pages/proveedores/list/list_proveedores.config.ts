...
export const ListProveedoresConfig: ITableListConfig = {
    ...
    columns: [
        ...
        { label: 'Empresa', property: 'ide_empr', type: 'text', sortable: true },
        ...
        { label: 'Primer Nombre', property: 'primer_nombre_prov', type: 'text', sortable: true },
        { label: 'Apellido Paterno', property: 'apellido_paterno_prov', type: 'text', sortable: true },
        { label: 'Segundo Nombre', property: 'segundo_nombre_prov', type: 'text', sortable: true },
        { label: 'Apellido Materno', property: 'apellido_materno_prov', type: 'text', sortable: true },
        {
            label: '',
            property: 'menu',
            type: 'ud',
